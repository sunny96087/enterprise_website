...
<template>
  <div v-if="specificData">
    ...
    <div class="banner">
      ...
      <div class="banner-title first-letter-underline">{{ specificData.serve_title_en }}</div>
    </div>
    ...
    <div class="page-content page-content-top flex flex-col gap-10">
      ...
      <div class="serve-block flex-col-reverse animate__animated animate__fadeInUp">
        ...
        <div class="serve-block-txt">
          <h3 class="serve-block-txt-title">
            {{ specificData.serve_block1_title_en }}
          </h3>
          <p class="serve-block-txt-content">
            {{ specificData.serve_block1_txt_en }}
          </p>
        </div>
      ...
      <div class="serve-block flex-col animate__animated animate__fadeInUp">
        ...
        <div class="serve-block-txt">
          <h3 class="serve-block-txt-title">
            {{ specificData.serve_block2_title_en }}
          </h3>
          <p class="serve-block-txt-content">
            {{ specificData.serve_block2_txt_en }}
          </p>
        </div>
      </div>
...
.serve-block {
  @apply flex md:grid md:grid-cols-2 items-center gap-5 md:gap-[60px];

  .serve-block-txt {
    @apply flex flex-col gap-2 md:gap-5 items-start w-full;
    ...
    .serve-block-txt-content {
      @apply text-zinc-800 lg:text-xl tracking-[3.20px];
    }
  }
